...
--Queries created for 7.3.2 Types of Joins
...
FROM employees
WHERE ( birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (hire_date BETWEEN '1985-1-01'AND '1988-12-31');
...
--Using Aliases to shorten queries.  The belwo is the same as above but using aliases
SELECT d.dept_name,
	dm.emp_no,
	dm.from_date,
	dm.to_date
